...
<div class="fallback-hero">
  <!-- <auro-background id="hero" role="img" inset="md" insetMd="xl" bgMd={imgBgMd}> -->
    <div class="hero__container">
      ...
      <div class="hero__offer-container">
        
        <div class="hero__offer">  
          <p class="hero__title hero__title-lg">{campaign.titleLg}</p>
          <p class="hero__headline hero__headline-lg">{campaign.headlineLg}</p>
          <!--CTA-->
          <auro-hyperlink ondark class="hero__cta-lg" data-type="standard" type="cta" href="{campaign.ctaLinkLg}?{campaign.campaignId}">{campaign.ctaLg}</auro-hyperlink>
...
<style>
  ...
  :root {
    --hero-background-image: radial-gradient(33% 145% at 100% 50%, var(--ds-color-brand-breeze-200) 99.5%, var(--ds-color-background-darkest) 100%);
    
    /* radial-gradient(22% 80% at 90% 40%, #00cff0 99.5%, #03C5FF00 100%),radial-gradient(100% 91% at 18% -19%, var(--ds-color-background-darkest) 1%, var(--ds-color-background-darkest) 99%);
    radial-gradient(22% 80% at 90% 40%, var(--ds-color-brand-breeze-200) 99.5%, #03C5FF00 100%),var(--ds-color-background-darkest); */
    --hero-background-color-primary: var(--ds-color-background-darkest);
    --merch4-background-color-secondary: var(--ds-color-brand-atlas-400);
    --merch4-background-color-accent: var(--ds-color-brand-breeze-200);
    --merch4-border-color-primary: var(--ds-color-border-darkest);
    --merch4-border-color-secondary: var(--ds-color-border-darker);
    ...
    --hero-font-size-lg: var(--ds-size-700);
    --hero-font-size-xs-color: #838d9c;
    --hero-font-family-accent: 'Bebas Neue';
    --hero-image-size-lg: 40%;
    --merch4-background-shape: 50%;
  }
  span#location {
    display: none;
  }
  ...
  .hero__offer {
    ...
    margin-block: var(--ds-size-100);
}
  .hero__headline {
    font-family: var(--hero-font-family-accent);
...
.hero__cta-lg {
    --auro-size-800: 3.5rem;
    margin-block: 0.5rem;
}
.hero__fineprint {
  color: var(--hero-font-size-xs-color);
