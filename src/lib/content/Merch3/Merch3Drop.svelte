...
<article class="merch" data-variant="3">
  <picture class="merch__img">
    ...
    <div class="merch__graphics">
      <auro-avatar type="md" code="lax"></auro-avatar>
      <div class="product__offer-wrapper">
        <div class="product__offer">30%</div>
        <div class="product__offer-detail">less.</div>
      </div>
      <img class="product__graphic-detail" src={planes} alt="planes" />
    </div>
  </picture>
  <div class="merch__content">
      <p class="product__title-sm" data-type="headline-sm">Hey Steven</p>
      <p class="product__title-md" data-type="headline-md">Hey Steven</p>
      <p class="product__title-lg" data-type="headline-lg">Hey Steven</p>
      <p class="product__bodycopy" data-type="bodycopy">Your flight to <span>LAX</span> is now <span>30%</span> less.</p> 
      <p class="product__flight-details auro_heading auro_heading--300" data-type="flight-details">Seattle, WA <sup class="airport-code">Sea</sup> <auro-icon category="interface" name="arrow-right"></auro-icon> Los Angeles, CA <sup class="airport-code">LAX</sup></p> 
