<script>
    ...
    import author_image from '$lib/images/as-card.svg';
  </script>
  <article class="author" data-variant="1">
    <picture>
        <!-- <img class="author_image" src={author_image} alt={author.author} /> -->
  ...
  /* .articleSummary {
    ...
    .articleSummary_author,.articleSummary_date {
      font-size: .8rem;
