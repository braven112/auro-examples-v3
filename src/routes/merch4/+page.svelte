...
<div class="mainContent">
	...
	<auro-header level="2" display="800">Merch 4 Credit Card Component</auro-header>
	<p>The component is inteded to be used in the footer, sidenav, anchor nav or as a full size banner.</p>
